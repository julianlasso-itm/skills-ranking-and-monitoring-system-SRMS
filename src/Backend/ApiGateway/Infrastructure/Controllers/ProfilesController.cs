...
namespace ApiGateway.Infrastructure.Controllers
{
    ...
    public class ProfilesController : BaseController
    {
        ...
        public async Task<IActionResult> GetCitiesAsync(
            [FromQuery] GetCitiesProfilesRequest request
        )
        {
            return await HandleAsync(
        ...
        public async Task<IActionResult> GetSkillsAsync(
            [FromQuery] GetSkillsProfilesRequest request
        )
        {
        ...
        )
        {
            ...
            return await HandleAsync(
                async () => Ok(await _profilesService.UpdateSubSkillAsync(request))
            );
        }
        ...
        public async Task<IActionResult> DeleteSubSkillAsync(string id)
        {
            ...
            return await HandleAsync(
                async () => Ok(await _profilesService.DeleteSubSkillAsync(request))
            );
        }
        ...
        {
            return await HandleAsync(
                async () => Ok(await _profilesService.GetSubSkillsAsync(request))
            );
        }
        ...
        {
            return await HandleAsync(
                async () => Ok(await _profilesService.RegisterSquadAsync(request))
            );
        }
        ...
        )
        {
            request.SquadId = id;
            return await HandleAsync(
                async () => Ok(await _profilesService.UpdateSquadAsync(request))
            );
        }
        ...
        public async Task<IActionResult> DeleteSquadAsync(string id)
        {
            ...
            return await HandleAsync(
                async () => Ok(await _profilesService.DeleteSquadAsync(request))
            );
        }

        [Permissions]
        [HttpGet("squads")]
        public async Task<IActionResult> GetSquadsAsync(
            [FromQuery] GetSquadsProfilesRequest request
        )
        {
            return await HandleAsync(
                async () => Ok(await _profilesService.GetSquadsAsync(request))
            );
        }
        ...
        [HttpGet("podiums")]
        public async Task<IActionResult> GetPodiumsAsync(
            [FromQuery] GetPodiumProfilesRequest request
        )
        {
            return await HandleAsync(
                async () => Ok(await _profilesService.GetPodiumsAsync(request))
            );
        }
    }
}
