...
namespace ApiGateway.Infrastructure.Controllers
{
    ...
    public class AccessControlController : BaseController
    {
        ...
        {
            return await HandleAsync(
                async () => Ok(await _accessControlService.SignInAsync(request))
            );
        }
        ...
        public async Task<IActionResult> GetRolesAsync(
            [FromQuery] GetRolesAccessControlRequest request
        )
        {
            return await HandleAsync(
        ...
        {
            var request = new ActivationTokenAccessControlRequest
            {
