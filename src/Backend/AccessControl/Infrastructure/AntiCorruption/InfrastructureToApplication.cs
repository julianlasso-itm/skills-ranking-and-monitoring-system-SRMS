...
namespace AccessControl.Infrastructure.AntiCorruption
{
    public class InfrastructureToApplication : IInfrastructureToApplication
    {
        ...
        public ActivateTokenCommand ToActivateTokenCommand(
        ...
        public SignInCommand ToSignInCommand(SignInAccessControlRequest request)
        {
            return new SignInCommand
            {
                ...
                PrivateKeyPath =
                    ...
                    ?? throw new ArgumentNullException(nameof(request.PrivateKeyPath)),
                PublicKeyPath =
                    request.PublicKeyPath
                    ?? throw new ArgumentNullException(nameof(request.PublicKeyPath)),
            };
        }
