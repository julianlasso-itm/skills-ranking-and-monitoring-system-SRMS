...
namespace AccessControl.Application.AntiCorruption.Interfaces
{
    public interface IApplicationToDomain
    {
        ...
        public ActivateTokenDomainRequest ToActivateTokenDomainRequest(
            ActivateTokenCommand request
        );
        public ActiveCredentialDomainRequest ToActiveCredentialDomainRequest(
            ActiveUserCommand request
        );
        ...
        public ChangePasswordDomainRequest ToChangePasswordDomainRequest(
        ...
        public ResetPasswordDomainRequest ToResetPasswordDomainRequest(
