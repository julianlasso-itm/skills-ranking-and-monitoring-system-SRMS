...
#pragma warning disable 612, 618
      ...
      modelBuilder.Entity(
        "Profiles.Infrastructure.Persistence.Models.CityModel",
        b =>
        {
          b.Property<Guid>("CityId").HasColumnType("uuid").HasColumnName("cty_city_id");

          b.Property<bool>("Disabled").HasColumnType("boolean").HasColumnName("cty_disabled");
          ...
          b.Property<Guid>("ProvinceId").HasColumnType("uuid").HasColumnName("prv_province_id");

          b.HasKey("CityId");

          b.HasIndex("ProvinceId");

          b.HasIndex("Name", "ProvinceId").IsUnique();
      ...
      modelBuilder.Entity(
        "Profiles.Infrastructure.Persistence.Models.CountryModel",
        b =>
        {
          b.Property<Guid>("CountryId").HasColumnType("uuid").HasColumnName("ctr_country_id");

          b.Property<bool>("Disabled").HasColumnType("boolean").HasColumnName("ctr_disabled");
      ...
      modelBuilder.Entity(
        "Profiles.Infrastructure.Persistence.Models.ProfessionalModel",
        b =>
        {
          ...
          b.Property<bool>("Disabled").HasColumnType("boolean").HasColumnName("prf_disabled");
      ...
      modelBuilder.Entity(
        "Profiles.Infrastructure.Persistence.Models.ProvinceModel",
        b =>
        {
          b.Property<Guid>("ProvinceId").HasColumnType("uuid").HasColumnName("prv_province_id");
          ...
          b.Property<bool>("Disabled").HasColumnType("boolean").HasColumnName("prv_disabled");
          ...
          b.HasIndex("Name", "CountryId").IsUnique();
      ...
      modelBuilder.Entity(
        "Profiles.Infrastructure.Persistence.Models.RoleModel",
        b =>
        {
          b.Property<Guid>("RoleId").HasColumnType("uuid").HasColumnName("rol_role_id");
          ...
          b.Property<bool>("Disabled").HasColumnType("boolean").HasColumnName("rol_disabled");
      ...
      modelBuilder.Entity(
        "Profiles.Infrastructure.Persistence.Models.SkillModel",
        b =>
        {
          b.Property<Guid>("SkillId").HasColumnType("uuid").HasColumnName("skl_skill_id");
          ...
          b.Property<bool>("Disabled").HasColumnType("boolean").HasColumnName("skl_disabled");
