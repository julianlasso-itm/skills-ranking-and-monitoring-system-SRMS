...
namespace Profiles.Application.UseCases
{
        ...
        where TEntity : class
    {
        ...
        public override async Task<RegisterCityApplicationResponse> Handle(
        ...
        private static RegisterCityApplicationResponse MapToResponse(
            RegisterCityDomainResponse city
        )
        {
